...
Let's add a bit of a human touch to the color wheel. Instead of a direct, 360-degree HSL color wheel mapping, I'd like to personalize the color that maps to each heading. Let's make:
